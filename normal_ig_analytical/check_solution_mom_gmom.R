...
V0 <- make_group_zellner_matrix(Z, diag(m), taugroup, group_idxs)

cat("Only groups: orthogonal approx first vs mom_gmom in mombf\n")
# use analytical solution ----------------
mom_gmom <- log_p_y_given_gam_gmom(y, Z, V0, g, a, b, group_idxs)[1]
print("mom_gmom")
paste(mom_gmom)
...
# use analytical solution ----------------
paste(log_p_y_given_gam_gmom(y, Z, V0, g, a, b, group_idxs)[1])
